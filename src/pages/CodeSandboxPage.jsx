      ...
      <main className="p-6 space-y-6 max-w-7xl mx-auto w-full">
        ...
        <div className="bg-[#111827] border border-slate-800 rounded-2xl p-6 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1">
            <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-[#090d16] text-purple-400 border border-slate-800 text-[11px] font-mono font-semibold">
              <Code2 className="w-3.5 h-3.5 text-purple-400" /> gVisor Container Environment
            </div>
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-sky-600 hover:bg-sky-500 text-white font-bold text-xs shadow-lg shadow-sky-950/50 transition-all active:scale-95 cursor-pointer shrink-0"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-7 bg-[#111827] border border-slate-800 rounded-2xl overflow-hidden shadow-xl flex flex-col">
            ...
            <textarea
              ...
              rows={16}
              className="w-full p-4 bg-[#080c14] font-mono text-xs text-slate-200 focus:outline-none resize-none leading-relaxed"
            />
          </div>
          ...
          <div className="lg:col-span-5 bg-[#111827] border border-slate-800 rounded-2xl overflow-hidden shadow-xl flex flex-col">
            <div className="bg-[#090d16] border-b border-slate-800 px-4 py-3 flex items-center justify-between text-xs font-mono">
              ...
              <span className="text-slate-400 text-[11px] font-semibold">gVisor Isolated</span>
            </div>

            <pre className="p-4 bg-[#080c14] font-mono text-xs text-emerald-400 leading-relaxed overflow-x-auto flex-1 whitespace-pre-wrap">
              {outputLog}
            </pre>
          </div>
        </div>
