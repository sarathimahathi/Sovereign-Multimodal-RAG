        ...
        <div className="bg-[#111827] border border-slate-800 rounded-2xl p-6 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1">
            <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-emerald-950/80 text-emerald-300 border border-emerald-500/40 text-[11px] font-mono font-semibold">
              <FileText className="w-3.5 h-3.5 text-emerald-400" /> MRPL Official Deliverable Gallery
            </div>
            ...
            >
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="px-2.5 py-0.5 rounded-lg bg-[#090d16] text-slate-300 border border-slate-800 text-[11px] font-mono uppercase font-bold">
                    {item.type}
                  </span>
              ...
              <div className="flex items-center gap-2 pt-2 border-t border-slate-800">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl bg-sky-600 hover:bg-sky-500 text-white font-bold text-xs transition-all cursor-pointer shadow-md"
                >
                  <Eye className="w-3.5 h-3.5" /> Preview Document
                </button>
                <button
                  onClick={() => alert(`Simulated Download: ${item.title}`)}
                  className="flex items-center justify-center p-2 rounded-xl bg-[#090d16] hover:bg-slate-800 border border-slate-800 text-slate-300 hover:text-white transition-all cursor-pointer"
                  title="Download File"
                >
